...
if (!$link) { 
    die('No se ha establecido la conexión con el servidor de base de datos : ' . mysqli_error($link)); 
} 
$db_selected2 = mysqli_query ($link, "CREATE DATABASE IF NOT EXISTS $bd;") or die(mysqli_error($link)); 
$db_selected = mysqli_select_db($link, $bd); 
if (!$db_selected) {
    echo 'No existe la base de datos',$db_selected,'<br/>'; 
    die (mysqli_error($link)); 
} else {
    echo "<h2>La base de datos <b>$bd</b> ha sido importada con éxito.</h2>";
$db_selected = mysqli_query ($link, "CREATE TABLE IF NOT EXISTS `copa` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5 ;") or die(mysqli_error($link)); 
$db_selected = mysqli_query ($link, "INSERT INTO `copa` (`idcopa`, `nombrecopa`, `fechaini`, `fechafin`, `premiocopa`, `ganadorcopa`) VALUES
(2, 'Copa Halloween', '2014-01-01', '2016-02-01', 150, ''),
(3, 'Copa Navidad', '2015-03-01', '2015-04-01', 50, ''),
(4, 'Copa Balon de Oro', '2014-12-01', '2014-12-31', 60, '');") or die(mysqli_error($link)); 
    
$db_selected = mysqli_query ($link, "CREATE TABLE IF NOT EXISTS `equipo` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=39 ;") or die(mysqli_error($link)); 
$db_selected = mysqli_query ($link, "INSERT INTO `equipo` (`idequipo`, `nombreequipo`, `liga`, `valoracion`, `imagenequipo`) VALUES
...
(38, 'Real Betis', 'Adelante', '2.8', 'Real Betis');") or die(mysqli_error($link)); 
    
$db_selected = mysqli_query ($link, "CREATE TABLE IF NOT EXISTS `juega` (
  `idjugador` int(4) DEFAULT NULL,
  `idcopa` int(4) DEFAULT NULL,
  UNIQUE KEY `idjugador` (`idjugador`,`idcopa`),
  KEY `idcopa` (`idcopa`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;") or die(mysqli_error($link)); 
$db_selected = mysqli_query ($link, "INSERT INTO `juega` (`idjugador`, `idcopa`) VALUES
(19, 2),
(20, 2),
(20, 3),
(20, 4),
...
(23, 2),
(23, 3),
(23, 4);") or die(mysqli_error($link)); 
    
$db_selected = mysqli_query ($link, "CREATE TABLE IF NOT EXISTS `jugador` (
  ...
  KEY `email` (`email`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=62 ;") or die(mysqli_error($link)); 
$db_selected = mysqli_query ($link, "INSERT INTO `jugador` (`idjugador`, `alias`, `nombre`, `apellidos`, `fecnac`, `email`, `pais`, `clave`, `equipofav`, `administrador`, `archivo`, `temapref`) VALUES
(19, 'admin', 'admin', 'admin', '2015-05-11', 'admin@email.com', 'Spain', '21232f297a57a5a743894a0e4a801fc3', 'Real Betis', 1, '19.jpg', 'original'),
(20, 'klunk', 'klunk', 'klunk', '2015-12-31', 'klunk@email.com', 'Metropolis', 'fd6408fa4296a98135c24e674e5abb73', 'Werder Bremen', 0, '20.jpg', 'original'),
(21, 'usuario1', 'usuario', 'uno', '2015-12-31', 'usuario1@email.com', 'Spain', '122b738600a0f74f7c331c0ef59bc34c', 'Barcelona', 0, '21.jpg', 'original'),
(22, 'usuario2', 'usuario', 'dos', '2015-12-31', 'usuario2@email.com', 'Spain', '2fb6c8d2f3842a5ceaa9bf320e649ff0', 'Borussia Dortmund', 0, '22.jpg', 'original'),
(23, 'usuario3', 'usuario', 'tres', '2015-12-31', 'usuario3@email.com', 'Spain', '5a54c609c08a0ab3f7f8eef1365bfda6', 'Juventus', 0, '23.jpg', 'original'),
(49, 'heinther', 'hei', 'n', '2015-05-20', 'heinther@gmail.com', 'Spain', '427572e1c91dc1ae8c81248d72d85655', 'Almeria', 0, '49.jpg', 'rojo'),
(52, 'javier', 'Javier', 'Rodriguez', '1992-08-21', 'javier21roga@gmail.com', 'Spain', '3c9c03d6008a5adf42c2a55dd4a1a9f2', 'Real Betis', 0, '52.jpg', 'original'),
(54, 'ganondorfoc', 'Feder', 'Ortega Cabrera', '1992-03-30', 'fedeortegacabrera@gmail.com', 'Spain', 'beeb6de877344eb0cab91cdaa186070e', 'Sevilla', 0, 'pordefecto.jpg', 'original'),
(59, 'prueba1000', 'prueba', '1991', '1992-12-31', 'prueba1000@email.com', 'Spain', 'df995f049c64984013000f6ef6446387', 'Chelsea', 0, 'pordefecto.jpg', 'original'),
(60, 'prueba1001', 'prueba', '1000', '1000-12-31', 'prueba1001@email.com', 'Spain', '29be9498bdee81e54aed63230ec53b5f', 'Hamburgo', 0, 'pordefecto.jpg', 'verde'),
(61, 'naxo14', 'Ignacio', 'Menchaca Recio', '1992-08-03', 'menchacaignacio@gmail.com', 'Spain', 'e10adc3949ba59abbe56e057f20f883e', 'Sevilla', 1, 'pordefecto.jpg', 'original');") or die(mysqli_error($link)); 
    
$db_selected = mysqli_query ($link, "CREATE TABLE IF NOT EXISTS `jugador_temp` (
  `alias` varchar(20) NOT NULL,
  `nombre` varchar(25) DEFAULT NULL,
  `apellidos` varchar(25) DEFAULT NULL,
  `fecnac` date NOT NULL,
...
$db_selected = mysqli_query ($link, "INSERT INTO `jugador_temp` (`alias`, `nombre`, `apellidos`, `fecnac`, `email`, `pais`, `clave`, `equipofav`, `administrador`, `archivo`, `text_Activ`) VALUES
...
('usuario3', 'usuario', 'tres', '2015-12-31', 'usuario3@email.com', 'Spain', '5a54c609c08a0ab3f7f8eef1365bfda6', 'Juventus', 0, '22.jpg', '5');") or die(mysqli_error($link)); 
    
$db_selected = mysqli_query ($link, "CREATE TABLE IF NOT EXISTS `liga` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=4 ;") or die(mysqli_error($link)); 
$db_selected = mysqli_query ($link, "INSERT INTO `liga` (`idliga`, `nombreliga`, `fecini`, `fecfin`, `premioliga`, `jornadas`, `aliasganador`) VALUES
(1, 'Liga Primavera', '2015-03-21', '2015-06-21', 1000, 20, ''),
(2, 'Liga Veraniega', '2015-06-22', '2015-09-22', 500, 20, ''),
(3, 'Liga Otonio', '2015-09-23', '2015-12-17', 1200, 20, '');") or die(mysqli_error($link)); 
    
$db_selected = mysqli_query ($link, "CREATE TABLE IF NOT EXISTS `participa` (
...
$db_selected = mysqli_query ($link, "INSERT INTO `participa` (`idjugador`, `idliga`, `puntos`) VALUES
(19, 1, 0),
(20, 1, 7),
(20, 2, NULL),
(21, 1, 4),
...
(22, 2, NULL),
(22, 3, NULL),
(23, 2, NULL);") or die(mysqli_error($link)); 
    
$db_selected = mysqli_query ($link, "CREATE TABLE IF NOT EXISTS `partido` (
  ...
  KEY `idcopa` (`idcopa`),
  KEY `idliga` (`idliga`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=44 ;") or die(mysqli_error($link)); 
$db_selected = mysqli_query ($link, "INSERT INTO `partido` (`idpartido`, `fecpartido`, `idlocal`, `idvisitante`, `golesloc`, `golesvis`, `ganadorpartido`, `idcopa`, `idliga`) VALUES
...
(43, '2015-02-12 12:12:00', 22, 23, 1, 3, 23, 2, NULL);") or die(mysqli_error($link)); 
    
$db_selected = mysqli_query ($link, "CREATE TABLE IF NOT EXISTS `usa` (
...
$db_selected = mysqli_query ($link, "INSERT INTO `usa` (`idjugador`, `idequipo`, `fecha`, `idpartido`) VALUES
...
(23, 10, '0000-00-00 00:00:00', 43);") or die(mysqli_error($link)); 
    
$db_selected = mysqli_query ($link, "ALTER TABLE `juega`
  ADD CONSTRAINT `juega_ibfk_1` FOREIGN KEY (`idjugador`) REFERENCES `jugador` (`idjugador`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `juega_ibfk_2` FOREIGN KEY (`idcopa`) REFERENCES `copa` (`idcopa`) ON DELETE CASCADE ON UPDATE CASCADE;") or die(mysqli_error($link)); 
    
$db_selected = mysqli_query ($link, "ALTER TABLE `jugador`
  ADD CONSTRAINT `jugador_ibfk_1` FOREIGN KEY (`equipofav`) REFERENCES `equipo` (`nombreequipo`) ON DELETE CASCADE ON UPDATE CASCADE;") or die(mysqli_error($link)); 
    
$db_selected = mysqli_query ($link, "ALTER TABLE `jugador_temp`
  ADD CONSTRAINT `jugador_temp_ibfk_1` FOREIGN KEY (`equipofav`) REFERENCES `equipo` (`nombreequipo`) ON DELETE CASCADE ON UPDATE CASCADE;") or die(mysqli_error($link)); 
    
$db_selected = mysqli_query ($link, "ALTER TABLE `participa`
  ADD CONSTRAINT `participa_ibfk_1` FOREIGN KEY (`idjugador`) REFERENCES `jugador` (`idjugador`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `participa_ibfk_2` FOREIGN KEY (`idliga`) REFERENCES `liga` (`idliga`) ON DELETE CASCADE ON UPDATE CASCADE;") or die(mysqli_error($link));
    
$db_selected = mysqli_query ($link, "ALTER TABLE `partido`
  ...
  ADD CONSTRAINT `partido_ibfk_5` FOREIGN KEY (`idliga`) REFERENCES `liga` (`idliga`) ON DELETE CASCADE ON UPDATE CASCADE;") or die(mysqli_error($link));
     
$db_selected = mysqli_query ($link, "ALTER TABLE `usa`
  ...
  ADD CONSTRAINT `usa_ibfk_3` FOREIGN KEY (`idpartido`) REFERENCES `partido` (`idpartido`) ON DELETE CASCADE ON UPDATE CASCADE;") or die(mysqli_error($link));
}
...
?>');
fclose($fp);
//Para borrar el fichero despues de haber sido ejecutado con éxito.
...
<head>
    ...
    <link href="./estilos/original/registro.css" rel="stylesheet" type="text/css" media="screen" />
