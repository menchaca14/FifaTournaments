...
//VARIABLE PARA ALMACENAR CONTENIDO QUE QUIERO MOSTRAR
$html = ' ';
...
//REQUIRE QUE CARGA EL DOMPDFE
require_once 'lib/dompdf-master/dompdf_config.inc.php';

//DATOS QUE QUEREMOS IMPRIMIR ALMACENANDOSE EN LA VARIABLE CREADA
...
//VARIABLE PARA CERRAR CAPA DONDE HE CENTRADO TODO
    $html.= "</div>";

            


// ESTAS LINEAS EXTRAEN LOS DATOS EN EL PDF
    $dompdf = new DOMPDF();
